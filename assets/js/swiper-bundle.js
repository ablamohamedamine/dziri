                    ...
                    t.params.a11y.enabled &&
                        (function () {
                            ...
                            a().removeEventListener("visibilitychange", C),
                                t.el && "string" != typeof t.el && (t.el.removeEventListener("focus", P, !0), t.el.removeEventListener("pointerdown", S, !0), t.el.removeEventListener("pointerup", M, !0));
                        })();
                });
        },
        function (e) {
                ...
                setTranslate: () => {
                    ...
                    for (let e = 0; e < a.length; e += 1) {
                        ...
                        let h = 0,
                            g = 0,
                            v = 0;
                        s % 4 == 0 ? ((h = 4 * -n * o), (v = 0)) : (s - 1) % 4 == 0 ? ((h = 0), (v = 4 * -n * o)) : (s - 2) % 4 == 0 ? ((h = o + 4 * n * o), (v = o)) : (s - 3) % 4 == 0 && ((h = -o), (v = 3 * o + 4 * o * n)),
                            l && (h = -h),
                            u || ((g = h), (h = 0));
